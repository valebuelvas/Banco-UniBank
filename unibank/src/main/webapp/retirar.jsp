    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light" id="mainNav">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand" href="index.html">Banco UniBank</a>
        ...
        <!-- Page Header-->
        <header class="masthead" style="background-image: url('resources/img/retir-bg.png')">
            <div class="container position-relative px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <div class="page-heading">
                            <h1>Retirar</h1>
                            <span class="subheading">Retira tu dinero fácilmente con UniBank</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        ...
                        <div class="my-5">
                            <form id="contactForm" action="/unibank/RetirarServlet" method="post">
                                ...
                                <p>Ingrese el monto a retirar en su cuenta.</p>
                                <div class="form-floating">
                                    <input class="form-control" id="name" name="retiro" type="text" placeholder="Enter your name..." data-sb-validations="required" required/>
                                    <label for="name">Retiro</label>
